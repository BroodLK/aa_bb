...
urlpatterns = [
    ...
    path(
        "stream_contracts_sse/", views.stream_contracts_sse, name="stream_contracts_sse"
    ),  # SSE feed for CB contracts.
    path(
        "stream_transactions_sse/", views.stream_transactions_sse, name="stream_transactions_sse"
    ),  # SSE feed for CB wallet transactions.
    ...
    ),  # Fetch detailed contract batch data.
]
