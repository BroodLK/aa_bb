    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alliance_check', models.PositiveIntegerField(default=30, help_text='How many days can a user be non compliant on alliance auth before he should get kicked?')),
                ('alliance_check_reason', models.TextField(blank=True, default='<@&{role}>,<@{namee}>\nSome of your characters are missing a valid token on alliance auth, go fix it', help_text='Message to send with {role} and {namee} variables', null=True)),
                ('alliance_check_reminder', models.TextField(blank=True, default="<@&{role}>,<@{namee}>, your compliance issue is still unresolved, you have {days} day(s) to fix it or you'll be kicked out.", help_text='Message to send with {role}, {namee} and {days} variables', null=True)),
